...
[<assembly: AssemblyVersionAttribute("1.3.43")>]
[<assembly: AssemblyFileVersionAttribute("1.3.43")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.43"
    let [<Literal>] AssemblyFileVersion = "1.3.43"
