...
[<assembly: AssemblyVersionAttribute("1.3.41")>]
[<assembly: AssemblyFileVersionAttribute("1.3.41")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.41"
    let [<Literal>] AssemblyFileVersion = "1.3.41"
