...
[<assembly: AssemblyVersionAttribute("1.3.38")>]
[<assembly: AssemblyFileVersionAttribute("1.3.38")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.38"
    let [<Literal>] AssemblyFileVersion = "1.3.38"
