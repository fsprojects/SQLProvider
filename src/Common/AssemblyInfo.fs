...
[<assembly: AssemblyVersionAttribute("1.3.42")>]
[<assembly: AssemblyFileVersionAttribute("1.3.42")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.42"
    let [<Literal>] AssemblyFileVersion = "1.3.42"
