...
[<assembly: AssemblyVersionAttribute("1.3.51")>]
[<assembly: AssemblyFileVersionAttribute("1.3.51")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.51"
    let [<Literal>] AssemblyFileVersion = "1.3.51"
