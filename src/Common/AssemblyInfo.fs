...
[<assembly: AssemblyVersionAttribute("1.3.49")>]
[<assembly: AssemblyFileVersionAttribute("1.3.49")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.49"
    let [<Literal>] AssemblyFileVersion = "1.3.49"
