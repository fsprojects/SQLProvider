...
[<assembly: AssemblyVersionAttribute("1.3.46")>]
[<assembly: AssemblyFileVersionAttribute("1.3.46")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.46"
    let [<Literal>] AssemblyFileVersion = "1.3.46"
