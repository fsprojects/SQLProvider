...
[<assembly: AssemblyVersionAttribute("1.3.52")>]
[<assembly: AssemblyFileVersionAttribute("1.3.52")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.52"
    let [<Literal>] AssemblyFileVersion = "1.3.52"
