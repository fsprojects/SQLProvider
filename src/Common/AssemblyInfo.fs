...
[<assembly: AssemblyVersionAttribute("1.3.45")>]
[<assembly: AssemblyFileVersionAttribute("1.3.45")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.45"
    let [<Literal>] AssemblyFileVersion = "1.3.45"
