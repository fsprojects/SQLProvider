...
[<assembly: AssemblyVersionAttribute("1.3.36")>]
[<assembly: AssemblyFileVersionAttribute("1.3.36")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.36"
    let [<Literal>] AssemblyFileVersion = "1.3.36"
