...
[<assembly: AssemblyVersionAttribute("1.3.50")>]
[<assembly: AssemblyFileVersionAttribute("1.3.50")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.50"
    let [<Literal>] AssemblyFileVersion = "1.3.50"
