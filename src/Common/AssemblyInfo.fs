...
[<assembly: AssemblyVersionAttribute("1.3.37")>]
[<assembly: AssemblyFileVersionAttribute("1.3.37")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.37"
    let [<Literal>] AssemblyFileVersion = "1.3.37"
