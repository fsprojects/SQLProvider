...
[<assembly: AssemblyVersionAttribute("1.3.47")>]
[<assembly: AssemblyFileVersionAttribute("1.3.47")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.47"
    let [<Literal>] AssemblyFileVersion = "1.3.47"
