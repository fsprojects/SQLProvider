...
[<assembly: AssemblyVersionAttribute("1.3.39")>]
[<assembly: AssemblyFileVersionAttribute("1.3.39")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.39"
    let [<Literal>] AssemblyFileVersion = "1.3.39"
