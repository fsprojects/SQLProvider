...
type SqlTypeProvider(config: TypeProviderConfig) as this =     
    ...
    let helpText = "<summary>Typed representation of a database</summary>
                    ...
                    <param name='Owner'>(Oracle Only) The owner of the schema for this provider to resolve. (PostgreSQL only) A list of schemas to resolve, separated by spaces, newlines, commas, or semicolons.</param>
