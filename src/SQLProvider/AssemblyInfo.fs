...
[<assembly: AssemblyVersionAttribute("1.1.90")>]
[<assembly: AssemblyFileVersionAttribute("1.1.90")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.90"
    let [<Literal>] AssemblyFileVersion = "1.1.90"
