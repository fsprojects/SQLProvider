...
[<assembly: AssemblyVersionAttribute("1.1.93")>]
[<assembly: AssemblyFileVersionAttribute("1.1.93")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.93"
    let [<Literal>] AssemblyFileVersion = "1.1.93"
