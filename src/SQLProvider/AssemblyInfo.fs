...
[<assembly: AssemblyVersionAttribute("1.1.68")>]
[<assembly: AssemblyFileVersionAttribute("1.1.68")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.68"
    let [<Literal>] AssemblyFileVersion = "1.1.68"
