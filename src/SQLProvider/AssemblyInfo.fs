...
[<assembly: AssemblyVersionAttribute("1.1.91")>]
[<assembly: AssemblyFileVersionAttribute("1.1.91")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.91"
    let [<Literal>] AssemblyFileVersion = "1.1.91"
