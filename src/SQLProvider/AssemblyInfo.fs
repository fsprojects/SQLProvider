...
[<assembly: AssemblyVersionAttribute("1.1.59")>]
[<assembly: AssemblyFileVersionAttribute("1.1.59")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.59"
    let [<Literal>] AssemblyFileVersion = "1.1.59"
