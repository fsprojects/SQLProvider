...
[<assembly: AssemblyVersionAttribute("1.1.69")>]
[<assembly: AssemblyFileVersionAttribute("1.1.69")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.69"
    let [<Literal>] AssemblyFileVersion = "1.1.69"
