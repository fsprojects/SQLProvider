...
[<assembly: AssemblyVersionAttribute("1.1.65")>]
[<assembly: AssemblyFileVersionAttribute("1.1.65")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.65"
    let [<Literal>] AssemblyFileVersion = "1.1.65"
