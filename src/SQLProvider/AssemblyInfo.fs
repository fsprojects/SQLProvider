...
[<assembly: AssemblyVersionAttribute("1.1.64")>]
[<assembly: AssemblyFileVersionAttribute("1.1.64")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.64"
    let [<Literal>] AssemblyFileVersion = "1.1.64"
