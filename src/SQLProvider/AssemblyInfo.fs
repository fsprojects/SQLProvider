...
[<assembly: AssemblyVersionAttribute("1.1.85")>]
[<assembly: AssemblyFileVersionAttribute("1.1.85")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.85"
    let [<Literal>] AssemblyFileVersion = "1.1.85"
