...
[<assembly: AssemblyVersionAttribute("1.1.86")>]
[<assembly: AssemblyFileVersionAttribute("1.1.86")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.86"
    let [<Literal>] AssemblyFileVersion = "1.1.86"
