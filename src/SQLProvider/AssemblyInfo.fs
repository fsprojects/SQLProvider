...
[<assembly: AssemblyVersionAttribute("1.1.76")>]
[<assembly: AssemblyFileVersionAttribute("1.1.76")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.76"
    let [<Literal>] AssemblyFileVersion = "1.1.76"
