...
[<assembly: AssemblyVersionAttribute("1.1.70")>]
[<assembly: AssemblyFileVersionAttribute("1.1.70")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.70"
    let [<Literal>] AssemblyFileVersion = "1.1.70"
