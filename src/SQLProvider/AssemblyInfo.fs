...
[<assembly: AssemblyVersionAttribute("1.1.34")>]
[<assembly: AssemblyFileVersionAttribute("1.1.34")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.34"
    let [<Literal>] AssemblyFileVersion = "1.1.34"
