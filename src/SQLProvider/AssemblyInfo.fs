...
[<assembly: AssemblyVersionAttribute("1.1.45")>]
[<assembly: AssemblyFileVersionAttribute("1.1.45")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.45"
    let [<Literal>] AssemblyFileVersion = "1.1.45"
