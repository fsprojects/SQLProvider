...
[<assembly: AssemblyVersionAttribute("1.1.80")>]
[<assembly: AssemblyFileVersionAttribute("1.1.80")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.80"
    let [<Literal>] AssemblyFileVersion = "1.1.80"
