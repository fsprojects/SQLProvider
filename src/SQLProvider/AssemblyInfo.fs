...
[<assembly: AssemblyVersionAttribute("1.1.67")>]
[<assembly: AssemblyFileVersionAttribute("1.1.67")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.67"
    let [<Literal>] AssemblyFileVersion = "1.1.67"
