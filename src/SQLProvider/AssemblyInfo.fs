...
[<assembly: AssemblyVersionAttribute("1.1.99")>]
[<assembly: AssemblyFileVersionAttribute("1.1.99")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.99"
    let [<Literal>] AssemblyFileVersion = "1.1.99"
