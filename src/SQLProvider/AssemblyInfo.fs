...
[<assembly: AssemblyVersionAttribute("1.1.82")>]
[<assembly: AssemblyFileVersionAttribute("1.1.82")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.82"
    let [<Literal>] AssemblyFileVersion = "1.1.82"
