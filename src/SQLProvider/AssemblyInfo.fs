...
[<assembly: AssemblyVersionAttribute("1.1.56")>]
[<assembly: AssemblyFileVersionAttribute("1.1.56")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.56"
    let [<Literal>] AssemblyFileVersion = "1.1.56"
