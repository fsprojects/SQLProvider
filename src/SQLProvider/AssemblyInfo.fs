...
[<assembly: AssemblyVersionAttribute("1.1.94")>]
[<assembly: AssemblyFileVersionAttribute("1.1.94")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.94"
    let [<Literal>] AssemblyFileVersion = "1.1.94"
