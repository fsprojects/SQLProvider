...
[<assembly: AssemblyVersionAttribute("1.1.74")>]
[<assembly: AssemblyFileVersionAttribute("1.1.74")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.74"
    let [<Literal>] AssemblyFileVersion = "1.1.74"
