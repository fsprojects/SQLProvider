...
[<assembly: AssemblyVersionAttribute("1.1.71")>]
[<assembly: AssemblyFileVersionAttribute("1.1.71")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.71"
    let [<Literal>] AssemblyFileVersion = "1.1.71"
