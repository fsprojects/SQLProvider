...
[<assembly: AssemblyVersionAttribute("1.1.84")>]
[<assembly: AssemblyFileVersionAttribute("1.1.84")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.84"
    let [<Literal>] AssemblyFileVersion = "1.1.84"
