...
[<assembly: AssemblyVersionAttribute("1.1.92")>]
[<assembly: AssemblyFileVersionAttribute("1.1.92")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.92"
    let [<Literal>] AssemblyFileVersion = "1.1.92"
