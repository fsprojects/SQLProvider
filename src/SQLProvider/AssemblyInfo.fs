...
[<assembly: AssemblyVersionAttribute("1.1.81")>]
[<assembly: AssemblyFileVersionAttribute("1.1.81")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.81"
    let [<Literal>] AssemblyFileVersion = "1.1.81"
