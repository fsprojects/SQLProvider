...
[<assembly: AssemblyVersionAttribute("1.1.75")>]
[<assembly: AssemblyFileVersionAttribute("1.1.75")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.75"
    let [<Literal>] AssemblyFileVersion = "1.1.75"
