...
[<assembly: AssemblyVersionAttribute("1.1.79")>]
[<assembly: AssemblyFileVersionAttribute("1.1.79")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.79"
    let [<Literal>] AssemblyFileVersion = "1.1.79"
