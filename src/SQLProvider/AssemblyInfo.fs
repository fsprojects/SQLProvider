...
[<assembly: AssemblyVersionAttribute("1.1.53")>]
[<assembly: AssemblyFileVersionAttribute("1.1.53")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.53"
    let [<Literal>] AssemblyFileVersion = "1.1.53"
