...
[<assembly: AssemblyVersionAttribute("1.1.97")>]
[<assembly: AssemblyFileVersionAttribute("1.1.97")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.97"
    let [<Literal>] AssemblyFileVersion = "1.1.97"
