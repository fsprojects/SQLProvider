...
[<assembly: AssemblyVersionAttribute("1.1.47")>]
[<assembly: AssemblyFileVersionAttribute("1.1.47")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.47"
    let [<Literal>] AssemblyFileVersion = "1.1.47"
