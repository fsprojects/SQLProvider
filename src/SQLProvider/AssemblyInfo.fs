...
[<assembly: AssemblyVersionAttribute("1.1.57")>]
[<assembly: AssemblyFileVersionAttribute("1.1.57")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.57"
    let [<Literal>] AssemblyFileVersion = "1.1.57"
