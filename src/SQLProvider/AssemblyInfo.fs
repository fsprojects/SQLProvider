...
[<assembly: AssemblyVersionAttribute("1.1.87")>]
[<assembly: AssemblyFileVersionAttribute("1.1.87")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.87"
    let [<Literal>] AssemblyFileVersion = "1.1.87"
