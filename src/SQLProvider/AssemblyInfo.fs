...
[<assembly: AssemblyVersionAttribute("1.1.98")>]
[<assembly: AssemblyFileVersionAttribute("1.1.98")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.98"
    let [<Literal>] AssemblyFileVersion = "1.1.98"
