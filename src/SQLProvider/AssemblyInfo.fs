...
[<assembly: AssemblyVersionAttribute("1.1.89")>]
[<assembly: AssemblyFileVersionAttribute("1.1.89")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.89"
    let [<Literal>] AssemblyFileVersion = "1.1.89"
