...
[<assembly: AssemblyVersionAttribute("1.1.63")>]
[<assembly: AssemblyFileVersionAttribute("1.1.63")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.63"
    let [<Literal>] AssemblyFileVersion = "1.1.63"
