...
[<assembly: AssemblyVersionAttribute("1.1.48")>]
[<assembly: AssemblyFileVersionAttribute("1.1.48")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.48"
    let [<Literal>] AssemblyFileVersion = "1.1.48"
