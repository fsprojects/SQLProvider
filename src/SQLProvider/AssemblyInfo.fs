...
[<assembly: AssemblyVersionAttribute("1.1.77")>]
[<assembly: AssemblyFileVersionAttribute("1.1.77")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.1.77"
    let [<Literal>] AssemblyFileVersion = "1.1.77"
